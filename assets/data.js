window.AI_EPIC_DATA = {
  "generatedAt": "2026-04-30T06:13:08.725Z",
  ...
  "articles": [
    {
      ...
      "tags": [],
      "summary": "快速上手 Agent Harness 实战 MicroHarness 本笔记根据视频 37242142994 1 192.mp4 的画面、音频和压缩预览分析整理。视频封面文字显示主题为“快速上手 Agent Harness 实战 Mic...",
      "wordCount": 4947,
    ...
    },
    {
      ...
      "summary": "Agent Harness：从能聊天到能干活的智能体运行框架 [!note] 来源说明 本笔记基于视频《8分钟快速掌握Agent Harness》的可解析内容、公开视频元数据，以及相关公开文章整理。原 B 站视频当前没有公开字幕，因此这...",
      "wordCount": 4818,
    ...
    },
    {
      ...
      "summary": "agent browser agent browser 是面向 AI Agent 的浏览器自动化 CLI，用于打开网页、读取页面结构、点击、输入、截图、下载、表单提交和网页测试。 一句话定位 当任务需要真实浏览器交互，而不是只读取网页文...",
      "wordCount": 1227,
    ...
    },
    {
      ...
      "summary": "Antigravity Antigravity 是 Google 的 agentic development platform。Google Codelabs 将它描述为把 IDE 推向 agent first 时代的平台，提供 Age...",
      "wordCount": 1466,
    ...
    },
    {
      ...
      "summary": "baoyu compress image baoyu compress image 用于压缩和转换图片，默认输出 WebP，也支持 PNG/JPEG。它通过脚本自动选择可用工具。 一句话定位 当用户要求压缩图片、优化图片体积、转换 We...",
      "wordCount": 841,
    ...
    },
    {
      ...
      "summary": "baoyu image gen baoyu image gen 是旧的多 provider AI 图片生成 Skill。其描述中已标注 deprecated，并提示使用 baoyu imagine ；在当前笔记体系中，新 OpenAI ...",
      "wordCount": 788,
    ...
    },
    {
      ...
      "summary": "Beads Beads 是面向 AI supervised coding workflows 的 git backed issue tracker。它的命令行名通常是 bd 。核心思路是把任务状态存进仓库中的 JSONL 文件，让任务、...",
      "wordCount": 1573,
    ...
    },
    {
      ...
      "summary": "brainstorming brainstorming 是一个前置设计 Skill，用来把模糊想法转成可执行设计。它不负责直接写代码，也不负责进入实现阶段；它的核心价值是先把“要做什么、为什么做、怎么判断做对了”弄清楚。 一句话定位 在...",
      "wordCount": 2502,
    ...
    },
    {
      ...
      "summary": "browser use browser use 是浏览器自动化 CLI，使用持久后台 daemon 保持浏览器会话。它适合网页测试、表单填写、截图、数据提取和真实 Chrome/Profile 连接。 一句话定位 当你需要稳定、持续地操...",
      "wordCount": 1417,
    ...
    },
    {
      ...
      "summary": "buddycode buddycode 的指向需要确认。公开搜索中至少出现两个可能相关但性质不同的结果： buddycodegpt.com 像是面向开发者的 AI coding desktop/tool； buddycodehub.co...",
      "wordCount": 810,
    ...
    },
    {
      ...
      "summary": "claude code 更新日志 本页只整理 2025 06 01 之后 Claude Code 的新功能、功能增强、配置能力和使用方式变化；不记录普通 bug fix。版本日期以 npm @anthropic ai/claude co...",
      "wordCount": 8731,
    ...
    },
    {
      ...
      "summary": "claude code 命令大全 本页整理 Claude Code 常用 CLI、交互式 slash commands、扩展命令和配置入口。命令可用性会受平台、账号计划、企业策略、安装方式和当前版本影响；最终以 /help 、 /com...",
      "wordCount": 5094,
    ...
    },
    {
      ...
      "summary": "Claude Code Harness：14 天 6 版集中进化速览 (2026.04) 近期，Claude Code 的 Harness 层在短短 14 天内连续发布了 6 个版本。需要明确的是，这并非模型本身的升级（如 Opus 4...",
      "wordCount": 2946,
    ...
    },
    {
      ...
      "summary": "claude code Claude Code 是 Anthropic 的 agentic coding tool。它以终端为核心入口，也可接入 IDE、桌面端、Web、GitHub/CI 和 SDK 自动化场景，用自然语言驱动代码阅读...",
      "wordCount": 5153,
    ...
    },
    {
      ...
      "summary": "claude mem claude mem 记录为与 Claude 或 Claude Code 相关的记忆/上下文插件。具体功能应按实际插件来源核对。 可能用途 保存项目偏好。 保存常用命令。 保存团队约定。 保存长期上下文。 适合保存...",
      "wordCount": 266,
    ...
    },
    {
      ...
      "summary": "code review graph code review graph 需要区分两个公开候选：一个是 PyPI 上的 code review graph ，另一个是社区页面中出现的 better code review graph 。二...",
      "wordCount": 1413,
    ...
    },
    {
      ...
      "summary": "codex Codex 是 OpenAI 的 coding agent，用于阅读、修改、运行和审查代码。它有多种使用界面，包括 CLI、本地 IDE/编辑器、Web/Cloud、GitHub 和 SDK/自动化场景。 定位 类型：AI ...",
      "wordCount": 1176,
      "sourceFile": "mydata/我的数据/AI记录/内容/codex.md",
      "markdown": "# codex\n\nCodex 是 OpenAI 的 coding agent，用于阅读、修改、运行和审查代码。它有多种使用界面，包括 CLI、本地 IDE/编辑器、Web/Cloud、GitHub 和 SDK/自动化场景。\n\n## 定位\n\n- 类型：AI coding agent。\n- 主要能力：读代码、改代码、运行命令、修 bug、写测试、做 code review、理解陌生代码库。\n- 使用形态：Codex CLI、Codex Web/Cloud、IDE 集成、GitHub/CI 集成、SDK。\n- 核心价值：把软件工程任务委托给能操作代码环境的 Agent，而不是只让模型生成片段。\n\n## 适合场景\n\n- 在本地仓库中实现功能。\n- 修复测试失败、lint 错误、构建错误。\n- 做多文件重构和迁移。\n- 阅读陌生代码库并总结结构。\n- 生成、补充或修复测试。\n- 在提交前做独立 code review。\n- 把长任务派给 cloud task 后回收 diff。\n\n## 不适合场景\n\n- 没有清楚目标和验收标准的开放式任务。\n- 未授权的删除、覆盖、重命名或批量修改。\n- 需要最新第三方 API 但不允许查文档的任务。\n- 需要访问生产系统、真实支付、敏感数据的任务。\n\n## CLI 基本用法\n\n官方文档给出的 CLI 安装方式之一：\n\n```text\nnpm i -g @openai/codex\ncodex\n```\n\nCodex CLI 会在选定目录中读、改、运行代码。首次运行需要登录，可用 ChatGPT 账号或 API key。\n\n## 常用任务提示\n\n```text\n阅读这个仓库，说明认证流程从请求进入到数据库写入的完整路径。只读，不修改文件。\n```\n\n```text\n修复当前 failing test。先定位原因，再做最小修改，最后运行相关测试。\n```\n\n```text\n为 auth 模块补测试，运行测试并修复失败项。不要改公共 API。\n```\n\n```text\n审查当前 diff，按严重程度列出 bug、风险和缺失测试。\n```\n\n## 与 MCP/Skills 的关系\n\n- MCP：给 Codex 额外工具和上下文，例如 [[AI记录/内容/context7|context7]]、[[AI记录/内容/serena|serena]]。\n- Skills：把重复工作封装成可复用流程，例如审查、前端设计、Obsidian 笔记整理。\n- AGENTS.md：项目规则文件，用来告诉 Codex 当前项目的约束、命令和沟通规范。\n\n## 风险控制\n\n- 删除、覆盖、重命名、批量修改前必须核对路径和影响范围。\n- 对用户已有改动不能随意回滚。\n- 每次完成都要提供真实验证结果，例如测试命令、构建结果、截图或 diff 检查。\n- 对联网查询、密钥、生产数据、外部 API 调用保持最小权限。\n\n## 与其他 IDE/Agent 的比较\n\n- 相比纯补全 IDE，Codex 更偏任务代理：能执行计划、修改文件、运行命令。\n- 相比 [[AI记录/内容/claude code|claude code]]，两者都适合终端/代码库工作，具体选择取决于模型、权限、项目规则、团队习惯和验证体验。\n- 搭配 [[AI记录/内容/context7|context7]] 可减少第三方 API 幻觉；搭配 [[AI记录/内容/serena|serena]] 可提升大型项目符号定位能力。\n\n## 使用判断\n\n当任务需要“读仓库、改文件、运行验证、给出可检查结果”时，Codex 适合作为主力 Agent。\n\n## 来源\n\n- [OpenAI Codex CLI 文档](https://developers.openai.com/codex/cli)\n- [OpenAI Codex Web/Cloud 文档](https://developers.openai.com/codex/cloud)\n- [OpenAI Codex 产品页](https://openai.com/codex/)\n- [OpenAI Code generation guide](https://developers.openai.com/api/docs/guides/code-generation)"
    },
    {
      "id": "note-18",
      "title": "context7",
      ...
      "summary": "context7 Context7 是一个面向 AI 编程代理的文档检索 MCP/CLI 工具。它的核心用途是把库、框架、SDK 的当前文档和代码示例拉进模型上下文，减少模型凭旧知识生成不存在或过时 API 的概率。 定位 类型：MCP...",
      "wordCount": 1438,
    ...
    },
    {
      ...
      "summary": "deepwiki DeepWiki 是面向 GitHub 仓库的 AI 文档和问答工具。它会为公开仓库生成可对话的 wiki 式说明，也提供 MCP server 让 Agent 通过工具访问仓库文档。 定位 类型：仓库级文档生成与问答...",
      "wordCount": 1125,
    ...
    },
    {
      ...
      "summary": "dispatching parallel agents dispatching parallel agents 用于把多个相互独立的问题域分派给多个子代理并行处理，避免串行调查浪费时间。 一句话定位 当存在 2 个以上互不依赖的问题，且...",
      "wordCount": 746,
    ...
    },
    {
      ...
      "summary": "find skills find skills 用于发现和安装适合某个任务的 Skill。它回答的问题不是“怎么做任务”，而是“有没有现成 Skill 可以帮我做”。 一句话定位 当用户问“有没有技能能做 X”“找一个能处理 Y 的 s...",
      "wordCount": 894,
    ...
    },
    {
      ...
      "summary": "frontend design frontend design 用于创建有明确审美方向、可运行、生产级的前端界面。它强调避免默认 AI 风格，要求根据产品语境选择清晰的视觉方向并完整执行。 一句话定位 当任务是网页、组件、页面、dash...",
      "wordCount": 1375,
    ...
    },
    {
      ...
      "summary": "gsd2 GSD 2 是 gsd build/gsd 2 仓库中的 Agent 应用/CLI。它从早期的 prompt framework 演进为一个 TypeScript 应用，用来控制 agent session、任务调度、上下文、...",
      "wordCount": 1377,
    ...
    },
    {
      ...
      "summary": "image manipulation image magick image manipulation image magick 用于通过 ImageMagick 对图片做确定性处理，包括尺寸读取、格式转换、缩放、缩略图和批处理。 一句话...",
      "wordCount": 920,
    ...
    },
    {
      ...
      "summary": "imagegen imagegen 用于通过 OpenAI Image API 生成或编辑图片。它适合网站素材、游戏素材、UI mockup、产品图、封面、信息图、概念图和批量变体。 一句话定位 当用户要“生成图片”或“编辑已有图片”时...",
      "wordCount": 1125,
    ...
    },
    {
      ...
      "summary": "internal comms internal comms 用于撰写内部沟通材料，例如 3P 更新、公司新闻稿、FAQ、状态报告、领导层更新、项目更新和事故报告。 一句话定位 当用户要写面向团队或公司内部的沟通文本时使用。 什么时候用 ...",
      "wordCount": 761,
    ...
    },
    {
      ...
      "summary": "json canvas json canvas 用于创建和编辑 Obsidian JSON Canvas 文件，也就是 .canvas 文件。它关注节点、边、位置、分组、连接关系和 JSON 合法性。 一句话定位 当任务是创建视觉画布、...",
      "wordCount": 931,
    ...
    },
    {
      ...
      "summary": "kilo code Kilo Code 是开源 AI coding agent，官方文档显示它可作为 VS Code 扩展、JetBrains 扩展和 CLI 使用，并通过 Kilo Gateway 接入大量模型。 定位 类型：AI c...",
      "wordCount": 1086,
    ...
    },
    {
      ...
      "summary": "mcp builder mcp builder 用于创建高质量 MCP server，让 LLM/Agent 能通过结构化工具调用外部 API、本地服务或业务系统。 一句话定位 不是“把 API 包一层”这么简单，而是设计一组让 Age...",
      "wordCount": 1392,
    ...
    },
    {
      ...
      "summary": "obsidian bases obsidian bases 用于创建和编辑 Obsidian Bases，也就是 .base 文件。Bases 能把笔记集合以 table、cards、list、map 等视图展示，并支持 filters...",
      "wordCount": 926,
    ...
    },
    {
      ...
      "summary": "obsidian markdown obsidian markdown 用于创建和编辑 Obsidian Flavored Markdown。它覆盖 Obsidian 特有语法：wikilinks、embeds、callouts、pro...",
      "wordCount": 1206,
    ...
    },
    {
      ...
      "summary": "pencil AI 工具 pencil 这个名称有多个可能指向。当前不能直接写成单一确定工具，需要先确认你目录里指的是哪一个。 已发现的候选 候选 1：Pencil by TryPencil TryPencil 是面向广告创意的 AI ...",
      "wordCount": 1407,
    ...
    },
    {
      ...
      "summary": "pencil MCP 这里的 pencil 需要先确认具体指向。公开资料中较接近的是 OpenPencil 的 MCP server：它让 AI coding tools 通过 MCP 读取和修改 OpenPencil 设计文件。但如果...",
      "wordCount": 1116,
    ...
    },
    {
      ...
      "summary": "playwright interactive playwright interactive 使用持久 js repl Playwright 会话调试 Web 或 Electron 应用。它强调不要每次重启工具链，而是复用浏览器、页面和 ...",
      "wordCount": 1101,
    ...
    },
    {
      ...
      "summary": "react best practices react best practices 是基于 Vercel Engineering 的 React/Next.js 性能优化指南，包含 8 类、57 条规则。它用于写、审查或重构 React...",
      "wordCount": 1819,
    ...
    },
    {
      ...
      "summary": "remotion best practices remotion best practices 用于 Remotion 视频项目。它把 React 组件、时间轴、音频、字幕、素材、渲染检查和 FFmpeg 辅助流程组织成可查规则。 一句...",
      "wordCount": 1207,
    ...
    },
    {
      ...
      "summary": "rust async patterns rust async patterns 用于 Rust async/Tokio 并发编程，包括 Future、Task、Runtime、channel、stream、错误处理和性能调优。 一句话定...",
      "wordCount": 996,
    ...
    },
    {
      ...
      "summary": "rust best practices rust best practices 基于 Apollo GraphQL 的 Rust Best Practices Handbook，用于编写、审查和重构 idiomatic Rust。 一句...",
      "wordCount": 1164,
    ...
    },
    {
      ...
      "summary": "seedance storyboard seedance storyboard 用于把视频创意转换成即梦 Seedance 2.0 专业分镜提示词。它适合短视频生成、分镜设计、参考素材组织和多模态提示词编写。 一句话定位 当用户想生成视...",
      "wordCount": 862,
    ...
    },
    {
      ...
      "summary": "serena Serena 是一个面向 coding agent 的 MCP 工具包，提供语义级代码检索、符号定位和编辑能力。它的目标是让 Agent 获得类似 IDE 的符号理解能力，而不是只靠文本搜索和行号修改。 定位 类型：MCP...",
      "wordCount": 1170,
    ...
    },
    {
      ...
      "summary": "skill creator skill creator 用于创建、修改、改进和评估 Skills。它适合把重复任务、团队流程、领域知识和工具脚本沉淀成 Agent 可调用能力。 一句话定位 当你发现某类任务会反复出现，而且每次都要重新解...",
      "wordCount": 901,
    ...
    },
    {
      ...
      "summary": "Skills 测试 Skills 测试用于确认 Skill 在真实任务中是否可靠。测试重点是行为，而不是文字漂亮。 测试目标 测试一个 Skill 时要确认： 是否正确触发。 是否读取必要说明。 是否按流程执行。 是否尊重风险边界。 是...",
      "wordCount": 802,
    ...
    },
    {
      ...
      "summary": "Skills 搭建 Skill 是把一类可复用任务沉淀成稳定流程的方式。它通常由 SKILL.md 、辅助脚本、模板、示例和参考资料组成，用来告诉 Agent 在特定场景下应该如何工作。 什么时候需要搭建 Skill 某类任务反复出现。...",
      "wordCount": 1116,
    ...
    },
    {
      ...
      "summary": "Skills 验收 Skills 验收的目标是确认它能稳定指导 Agent 完成任务，而不是只检查文档是否写得完整。 验收结论分级 通过：标准任务能完成，边界任务能正确降级，反例不会误触发。 有条件通过：主流程可用，但某些风险或验证不足...",
      "wordCount": 835,
    ...
    },
    {
      ...
      "summary": "Skills Graph Skills Graph 用于描述 Skills 之间的依赖、分工、层级和调用关系。它既是一张“谁先谁后、谁验证谁、谁委托谁”的使用地图，也是一套设计 Agent 工作杠杆的方法。 它要解决的核心问题不是“我有...",
      "wordCount": 4543,
    ...
    },
    {
      ...
      "summary": "starwards pixijs starwards pixijs 是 Starwards 项目的 PixiJS v8 开发指南，覆盖 Application、Container、Sprite、Graphics、Texture、Tick...",
      "wordCount": 1046,
    ...
    },
    {
      ...
      "summary": "superpower superpower 这里指一组强调流程纪律的 Skills 集合。核心入口是 using superpowers ：它要求在任务开始时先检查是否有适用 Skill，并在执行前读取当前版本的 Skill 原文。 一...",
      "wordCount": 1290,
    ...
    },
    {
      ...
      "summary": "trae Trae IDE 是 ByteDance 的 AI powered code editor。官方文档将它描述为带有代码补全、智能建议和 agent based programming 能力的 AI 编程 IDE。 定位 类型：...",
      "wordCount": 912,
    ...
    },
    {
      ...
      "summary": "ui ux pro max ui ux pro max 是 UI/UX 设计知识库型 Skill，覆盖设计风格、配色、字体、产品类型、UX 指南、图表类型和多技术栈实现建议。 一句话定位 当任务会改变界面的外观、交互、信息结构或体验质量...",
      "wordCount": 1046,
    ...
    },
    {
      ...
      "summary": "impeccable 是一个面向生产级前端界面的设计、审查、打磨和实现 Skill。它强调 PRODUCT/DESIGN 上下文、register 判断、命令化流程和真实浏览器验证，适合优化网站、dashboard、产品 UI、组件、表单、响应式、动效、配色与排版。",
      "wordCount": 4079,
